...
public class Topic {
	...
	private String topic_practice_time_recommended;
	...
	private List<String> topic_children_types;
	private List<String> topic_children;
	private List<String> topic_related_tags;
	private List<String> topic_start_gyan;
	private List<String> topic_authors_advice;
